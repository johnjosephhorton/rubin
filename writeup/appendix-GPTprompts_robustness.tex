...
Here, we re-estimate Equation~\eqref{eq:fragmentation_index_regression} using task orderings generated by the alternative prompts and report the analogs of the estimates in Table~\ref{tab:fragmentation_index_regression_exposure}.
