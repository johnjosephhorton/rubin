...
Second, we re-estimate Equation~\eqref{eq:fragmentation_index_regression} using task orderings generated by the alternative prompts and report the analogs of the estimates in Table~\ref{tab:fragmentation_index_regression_exposure}.
...
Finally, we assess the robustness of our spillover results for neighboring tasks being AI-executed on the focal task's likelihood of AI execution.
