...
We characterize how a firm optimally assigns humans and AI across the steps of its workflow, and show that AI chaining can overturn comparative advantage logic.
A step at which humans hold an advantage in isolation may still be automated when it sits beside strong AI-performing steps, because chaining removes the human verification checkpoint between them.
...
Empirical evidence supports the model's key predictions that (1) AI-executed steps co-occur in chains, (2) a step's local context, the extent to which the work around it is AI-executed, increases the likelihood that the step itself is AI-executed, and (3) dispersion of AI-exposed steps predicts lower AI execution at the workflow level.
We then embed this chaining problem in the firm's longer-run redesign of jobs around AI, and show that, under additional assumptions on how firms differ in their effective AI quality, firm-level production admits a macroeconomic CES representation.
