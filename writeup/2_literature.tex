...
We complement this literature by highlighting that whether AI executes a task depends not only on the task's own characteristics but also on its neighbors in the workflow.
