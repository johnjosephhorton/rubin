...
We depart from this literature by modeling production as a sequence of technologically interdependent steps, where AI chaining creates complementarities across adjacent steps that can overturn comparative advantage as the driver of who does what.\footnote{Two contemporary works by \cite{trammell2026workflows} and \cite{farboodi2026data} study a different form of linkage across tasks: production still occurs task by task, but performing a task raises productivity on others through learning, by workers in the former and by machines in the latter. Our emphasis is instead on the ordering of tasks in production.}
...
We depart from this literature by showing that linear aggregation obscures the role of task interdependence: what matters is where an occupation's AI-exposed steps sit relative to one another, not merely how many there are, which is what the fragmentation index of Section~\ref{sec:fragmentation} captures.
...
Because these returns arrive only once AI quality passes such a threshold, the marginal benefit of improving AI is non-monotone, and in this sense our framework provides a micro-foundation for the ``productivity J-curve'' argument \citep{brynjolfsson2021productivity}, consistent with analyses of U.S. Census microdata showing that AI adoption initially reduces productivity \citep{mcelheran2025rise} and with related evidence \citep{furman2019ai, tambe2012productivity, bonney2024tracking, mcelheran2024adoption}.
...
Applied to the ``boundary of the job,'' the Coase--Williamson logic that economic boundaries are shaped by coordination, transaction, and governance costs \citep{coase1937nature, williamson1971vertical, williamson1979transaction} implies that the firm chooses how many and which tasks to bundle into a worker's role, making the degree of specialization endogenous \citep{murphy1986specialization, becker1992division, dessein2006adaptive}.
Our hand-off costs are the intra-firm analogue of the transaction costs AI does not directly reduce, resting as they do on tacit or social knowledge \citep{deming2017growing}; AI nonetheless redraws job boundaries by stripping skill out of the steps it absorbs, effectively changing the skill requirements of jobs \citep{autor2024new, autor2025expertise, autor2026makes}.\footnote{
\cite{ide2025ai} provides a related view, embedding AI as an autonomous problem solver in a knowledge hierarchy \citep{garicano2000hierarchies, garicano2006organization} and studying how it reshapes spans of control within the firm.
}
