...
For Prediction~\#3 it reports a stricter definition of when two tasks count as the same step across occupations, and the same regressions run on AI automation rather than on AI execution.
