...
Since the measure of firms in the economy is normalized to $1$, aggregate capital is also normalized to $1$, making the third term in Equation~\eqref{eq:macro_agg_prod} effectively constant at $1-\theta_{\AIletter}-\theta_{\manualLetter}$.
...
A firm with effective AI quality $\bar{\alpha}$ thus produces output $y = \phi(\bar{\alpha})$ by definition.
