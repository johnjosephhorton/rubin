...
\end{equation}
which is what the boundary condition at $\bar{\alpha} \to 1$.
...
Allowing firms that anticipate deploying AI more effectively to organize work differently would make $\skillAdjustedTimeLetter_{\manualLetter}$ vary with $\bar{\alpha}$ and restore the missing dimension, at the cost of a joint distribution over organizational choices and realized quality; we leave this to future work.
