...
\[
\skillAdjustedTimeLetter_b = \frac{w_{\manualLetter} \left(\sum_{T_{\ell}^{\manualLetter} \in J(b)} \manualSkill{\ell}\right) + w_{\AIletter} \left(\sum_{T_{\ell}^{\AIletter} \in J(b)} \AIskill{\ell}\right)}{w_{E(b)}} \, \timecost{b}.
\]
