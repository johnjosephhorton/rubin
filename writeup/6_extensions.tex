...
Section~\ref{sec:extensions.aggregation} reconciles our firm-level, sequential model of production with models that study the implications of automation from a macro perspective by aggregating individual firms' production functions into a single CES production function at the macro level.
