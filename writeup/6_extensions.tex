...
Two economies with identical production steps, arranged differently within workflows, aggregate to the same CES form \eqref{eq:lr_macro_ces} but with different production parameters and input requirements.
