...
The heatmap layout and the significance stars are as in Figure~\ref{fig:frag_frequency}, except that the number beneath each estimate is the number of task observations and the top ``All tasks'' row is the unpruned specification of Section~\ref{sec:DWA_prediction}.
