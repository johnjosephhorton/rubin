...
Our sequencing approach recovers the orderings in both external sources to a substantial degree, and our main predictions continue to hold when we re-estimate them on the practitioner-ordered PCF corpus (Appendix~\ref{app:external_validation}).
