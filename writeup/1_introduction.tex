...
Automation is therefore available only inside a chain: a lone AI step must have its output verified, so chaining is what lets AI work unsupervised.
...
\pscomment{Yeah. Reads weird and feels forced... :)} Because chaining makes the cost of automating a step depend on its neighbors, the firm must optimize costs over all possible configurations rather than proceeding step by step.
...
\pscomment{Should we move this after the empirics? We go: firm -- aggregate -- firm.}
