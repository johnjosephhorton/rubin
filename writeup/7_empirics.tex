...
The two corpora also differ in composition, with $44\%$ of O*NET steps AI-able against $12\%$ in the PCF, both because the O*NET-PCF match is lossy and because the framework's scope is narrower than O*NET's.
