...
To model how AI affects occupations---viewed here as collections of tasks---we need some account of why those tasks were put together in an occupation in the first place.
...
Suppose production of a typical final good requires completing an ordered set of tasks, denoted by:
\[
...
In this appendix, we obtain equilibrium prices and allocations for the model specified in Section~\ref{GE}.
