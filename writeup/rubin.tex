...
\begin{figure}[h]
  ...
  \end{footnotesize}
\end{figure}
The sharp contrast between such tasks creates substantial inefficiencies, discouraging AI chaining and instead pushing firms toward individual task specialization.
...
Figure~\ref{fig:wage_bill} illustrates a simple occupation with just two tasks and thus two job designs: [1][2] and [1,2].  
...
\begin{figure}[h]
  ...
  \end{center}
  \begin{footnotesize}
    \emph{Note:} Each panel of the graph shows the geometric representation of the wage bill for a job design of an occupation with two tasks.  
