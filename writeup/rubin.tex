...
%%%%%%%%%%%%
% First introduce tasks as having two cost dimensions: time cost and human capital cost
% Add a short-run versus long-run argument
%%%%%%%%%%%%
...
\begin{figure}[ht]
  ...
  \end{center}
  \footnotesize{
  \emph{Notes:} This figure illustrates labor division across five tasks: Tasks 1 and 5 are done manually by human; Tasks 2--3 are AI‐automated; Task 4 is AI‐augmented. The brace above tasks 2--4 indicates AI involvement in completing those tasks; downward lines show which tasks require human execution or oversight. 
  }
\end{figure}
