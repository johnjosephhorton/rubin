...
\end{array}
\]
Notice that while the optimal job design earlier was assigning a single worker to each task (i.e., the [1][2][3] design), after the introduction of hand-off friction the minimum cost-way of production becomes the [1,2][3] design.
