...
Because a chain links several steps into a single unit of execution, the firm cannot solve the problem in \eqref{eq:totalcost_shortterm} step by step, and cost minimization instead requires comparing all feasible arrangements of the workflow.
