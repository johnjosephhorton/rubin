...
% TEMP: Appendix~\ref{app:ca_local_proof} proves Proposition~\ref{prop:ca_local} of Section~\ref{sec:comparative_advantage}.
...
% TEMP: the proof of Proposition~\ref{prop:ca_local} currently sits inline in
% 4_discussion.tex, directly under the proposition, for review.  To restore it
% here, move the block between the TEMP markers in that file back to this spot,
% re-adding the subsection heading and the \label{app:ca_local_proof}, and
% uncomment the sentence about it in the paragraph above.
