...
Section~\ref{app:mediumrun_dp} extends the firm's AI deployment problem of Section~\ref{sec:jobs_wages} to the case in which wages adjust to the skill a job requires.
