...
Sections~\ref{app:shortrun_proof} and~\ref{app:mediumrun_dp} prove Propositions~\ref{prop:shortrun_dp} and~\ref{prop:mediumrun_dp} of Section~\ref{sec:extensions.computation}, the first for the firm's short-run AI deployment problem and the second for the case in which wages adjust to the skill a job requires.
...
Recall the problem of Section~\ref{sec:extensions.computation}, in which the wage adjusts to the skill a job requires and the firm minimizes the job's wage bill \eqref{eq:totalcost_mediumrun}, the product of its total skill and its total time.
