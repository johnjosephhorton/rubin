The preceding sections focused on the firm's problem over both short- and long-run horizons.
This section collects two further results that the framework delivers.
...
What ultimately matters, however, is how these firm-level adjustments translate into the broader labor market: how much labor of each kind the economy employs, how output responds to capital and to labor, and what becomes of both as AI improves.
These are the terms the automation literature works in, writing production functions directly at the level of the economy \citep{acemoglu2018, acemoglu2022artificial, acemoglu2024tasks}.
