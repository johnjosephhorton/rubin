...
The firm cannot decide step by step, then, and must instead compare whole arrangements, of which a workflow of $m$ steps admits exponentially many.
...
This subsection shows that it is not, on either horizon: the short-run problem is solved exactly and cheaply, and the long-run problem to any accuracy the firm cares to specify, each by dynamic programming.
We take the two in turn.
