...
In Section~\ref{sec:longrun} we we allow the firm to also choose how to divide the steps among workers, so the skill a job demands, and hence the wage it commands, becomes an endogenous object.
...
What the firm does in the short run is lowering its production costs by optimally creating AI chains, and it does so while the content of the worker's job, and hence the rate at which they are paid, are held fixed.
