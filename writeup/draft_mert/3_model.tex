...
We develop this long-run problem, which nests the medium run as the special case of fixed job boundaries, and provide a polynomial-time approximation of its solution, in Appendix~\ref{app:jobdesign.longrun}.
