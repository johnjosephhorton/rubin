...
Section~\ref{sec:results} works through the implications of chaining, and Section~\ref{sec:extensions.computation} shows how the solution to the short-run problem can be calculated.