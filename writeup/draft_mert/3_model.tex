...
This can reflect the short-run dynamics of the economy, in which the firm has already determined the set of tasks for a worker and hired them at a pre-specified wage rate.
Section~\ref{sec:longrun} then lets the firm decide how to assign steps across multiple workers to further optimize its organizational structure.
