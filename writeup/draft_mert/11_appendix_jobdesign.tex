...
The main text studies the firm's AI deployment problem: choosing how to chain and automate steps so as to minimize the cost of production, $\sum_b \skillcost{b}\,\timecost{b}$, where each task is staffed by a dedicated worker possessing the skill it requires (Section~\ref{sec:jobs_wages}).
...
This contrasts with the AI deployment problem of Section~\ref{sec:jobs_wages}, which minimizes the cost of production while fixing the assignment of tasks to workers. 
