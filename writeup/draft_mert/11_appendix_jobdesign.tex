...
\end{tabularx}
    ...
    \begin{minipage}{1\linewidth}
\begin{spacing}{0.2}
{\fontsize{9.5pt}{10pt}\selectfont Notes: This table collects the additional notation introduced in this appendix for the firm's long-run job design problem. It supplements the model notation of Table~\ref{tab:model_parameters}, which continues to apply throughout.}
\end{spacing}
\end{minipage}
\end{table}
...
\begin{minipage}{1\linewidth}
\begin{spacing}{0.2}
{\fontsize{9.5pt}{10pt}\selectfont Notes: This figure illustrates tent‐pole tasks.
