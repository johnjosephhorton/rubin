...
The notation for job design is collected in Table~\ref{tab:jobdesign_parameters} of the main text.
...
Proposition~\ref{prop:totalcost_optimization_dp} shows that, like that problem, the long-run problem admits a polynomial-time approximation scheme.
