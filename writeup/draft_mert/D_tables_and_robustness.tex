...
This appendix collects two tables referenced from the theory sections, together with supplementary robustness results for Predictions~\#2 and~\#3 of Section~\ref{sec:empirics}.
