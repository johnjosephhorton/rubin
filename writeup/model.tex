...
The firm thus minimizes the wage bill of jobs, taking the set of tasks in each as given.
Minimizing total wage bill of all jobs when jobs are independent of one another can be simplified to minimizing the cost of each job independently, which is what we do below.
