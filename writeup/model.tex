...
Although the number of possible AI strategies over the $m$ steps grows exponentially in $m$, the cost-minimizing strategy can be computed via dynamic programming in $O(m^2)$ time, as shown in Proposition~\ref{prop:shortrun_dp} below.
...
Deploying AI lowers cost on both margins, since an augmented or automated step may demand both less skill and less time than manual execution.
