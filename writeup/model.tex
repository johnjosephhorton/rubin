...
The firm employs human workers to performs tasks and produce the final output.
...
Since labor is the only cost of production, the firm's objective is to minimizes its wage bill paid to workers.
...
Next we turn into solving the medium-run problem. 
...
The solution of the long-run problem has a similar flavor to the medium-run case, but rather than fixing the steps assigned to a the worker it also chooses how tasks are allocated across different workers. 
