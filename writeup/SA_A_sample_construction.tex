...
Unless explicitly mentioned otherwise, in all analyses we treat tasks with a human-assigned E1 or E2 label as exposed to AI and those with an E0 label as unexposed to AI.\footnote{
