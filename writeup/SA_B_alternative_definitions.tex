...
\section[Alternative Definitions of Empirical Fragmentation, Step Similarity, and AI Execution]%
        {Alternative Definitions of Empirical Fragmentation,\texorpdfstring{\\}{ }Step Similarity, and AI Execution}
...
For Prediction~\#2 it replaces the exposure-based fragmentation measure with an execution-based one.
For Prediction~\#3 it tightens what it means for two tasks to be the same step across occupations, and replaces AI execution with the stricter outcome of AI automation.
...
\subsection{Prediction \#2: An Execution-Based Empirical Fragmentation Measure}
...
\subsection{Prediction \#3: Stricter Step Similarity and AI Automation}
