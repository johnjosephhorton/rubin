...
\pscomment{Changed the citation here and removed BM citation from the next paragraph} In reality, work is not organized this way, because dividing production among many workers is costly.
...
\pscomment{Made this paragraph about reduction in time cost more generally (rather than just lowered hand-off costs)}
The second channel is time.
For many steps, checking what AI produces takes less time than performing them, so the tasks AI absorbs become narrow rectangles as well as short ones.
