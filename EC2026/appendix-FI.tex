...
\subsection{Examples Showing the Importance of Task Order on Job-Level AI Exposure}
\label{app:examples.task.order}
...
\[ FI(\mathcal{S}) = E\left[ \sum_{s_i \in F}\minTime{i} + \sum_{C_j \in \mathcal{C}} \omega(C_j) \right] \]
where the expectation is over the realization of $F$ and $\mathcal{C}$.
