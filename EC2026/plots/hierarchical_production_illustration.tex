...
\begin{adjustbox}{center,trim=0pt 0pt 0pt 0pt,clip,margin=-2cm 0cm}
  \begin{tikzpicture}[scale=0.7, transform shape,
    ...
    dashedbox/.style={draw, rectangle, rounded corners, dashed, inner sep=0.175cm, line width=1pt},
    ...
    \node[humanbox, below=2cm of CenterTop, xshift=-6cm] (T1) {Task 1\\(Human)};
    ...
    % Job layer nodes
    \node[jobbox, below=1.2cm of T3] (J2) {Job 2};
