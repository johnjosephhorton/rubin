\section{Robustness of Task Orderings to Alternative GPT Prompts}
...
We use the same structure as the first prompt in Appendix~\ref{app:prompts}, but only replace the sentence starting with ``\textit{Provide the typical sequential...}'' with an alternative from the list below:
\begin{enumerate}
...
\begin{subfigure}[t]{0.49\linewidth}
    \centering
    \caption{Full Sample}
    \includegraphics[width=\linewidth]{plots/GPT_task_sequence_robustness_distribution.png}
\end{subfigure}
\hfill
\begin{subfigure}[t]{0.49\linewidth}
    \centering
    \caption{Empirical Fragmentation Index Split}
    \includegraphics[width=\linewidth]{plots/GPT_task_sequence_robustness_by_fragmentation_index_distribution.png}
\end{subfigure}
...
\begin{subfigure}[t]{0.49\linewidth}
    ...
    \includegraphics[width=\linewidth]{plots/GPT_task_sequence_robustness_by_human_E1_fraction_distribution.png}
\end{subfigure}
\hfill
\begin{subfigure}[t]{0.49\linewidth}
    \centering
    \caption{AI Execution Split}
    \includegraphics[width=\linewidth]{plots/GPT_task_sequence_robustness_by_ai_fraction_distribution.png}
\end{subfigure}
...
%     \includegraphics[width=0.95\linewidth]{plots/GPT_task_sequence_robustness_by_fragmentation_index.png}
%     \end{center}
...
%     \includegraphics[width=0.95\linewidth]{plots/GPT_task_sequence_robustness_by_human_E1_fraction.png}
%     \end{center}
...
%     \includegraphics[width=0.95\linewidth]{plots/GPT_task_sequence_robustness_by_ai_fraction.png}
%     \end{center}
...
Here, we examine how sensitive the measured average AI chain length is to the choice of GPT prompt.
Figure~\ref{fig:ai_chains_length_count_prompt_robustness} reports this metric computed under each prompt.
Across prompts, average AI chain length remains tightly clustered around the baseline value implied by the main prompt.
In particular, the mean across alternative prompts matches the sample estimate from the main prompt, which lies in the extreme tail of both placebo distributions in Figure~\ref{fig:aiChains_graphs_def1}.
\begin{figure}[ht!]
\caption{Robustness of Average AI Chain Length to GPT Prompts}
\label{fig:ai_chains_length_count_prompt_robustness}
\begin{center}
\includegraphics[width=0.8\textwidth]{plots/aiChain_length_robustness.png}
\end{center}
\raggedright \footnotesize{
\emph{Notes:} This figure shows that the average AI chain length measure is robust to alternative prompt formulations.
The plot reports average AI chain length computed separately under each prompt.
...
The dashed orange line reports the mean of the statistic across all 11 prompts.
}
\end{figure}
...
\begin{figure}[ht!]
  ...
  \begin{subfigure}[b]{\textwidth}
    ...
    \includegraphics[width=\textwidth]{plots/fragmentation_index_robustness_definition_3.png}
  \end{subfigure}
  ...
  \begin{subfigure}[b]{\textwidth}
    ...
    \includegraphics[width=\textwidth]{plots/fragmentation_index_robustness_definition_4.png}
  \end{subfigure}
  \end{center}
...
\begin{figure}[ht!]
  ...
  \begin{subfigure}[b]{\textwidth}
    ...
    \includegraphics[width=\textwidth]{plots/fragmentation_index_robustness_definition_1.png}
  \end{subfigure}
  ...
  \begin{subfigure}[b]{\textwidth}
    ...
    \includegraphics[width=\textwidth]{plots/fragmentation_index_robustness_definition_2.png}
  \end{subfigure}
  \end{center}
  \raggedright \footnotesize{\emph{Notes:} This figure shows that the estimated relationships between occupation-level AI execution and both AI exposure and the empirical fragmentation index are robust to alternative prompt formulations.
...
\begin{figure}[ht!]
  ...
  \begin{subfigure}[b]{\textwidth}
    ...
    \includegraphics[width=\textwidth]{plots/ame_no_fe_no_dwa_robustness.png}
  \end{subfigure}
  ...
  \begin{subfigure}[b]{\textwidth}
    ...
    \includegraphics[width=\textwidth]{plots/ame_major_fe_no_dwa_robustness.png}
  \end{subfigure}
  ...
  \begin{subfigure}[b]{\textwidth}
    ...
    \includegraphics[width=\textwidth]{plots/ame_minor_fe_no_dwa_robustness.png}
  \end{subfigure}
  ...
  \begin{subfigure}[b]{\textwidth}
    ...
    \includegraphics[width=\textwidth]{plots/ame_no_fe_with_dwa_robustness.png}
  \end{subfigure}
  \end{center}
