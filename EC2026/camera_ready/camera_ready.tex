...
%% TODO: confirm selection (and significance weights) with coauthors.
\begin{CCSXML}
<ccs2012>
   <concept>
...
\keywords{AI automation, task-based production, job design, division of labor, task chaining, future of work}
