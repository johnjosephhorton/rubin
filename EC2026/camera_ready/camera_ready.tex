...
% TODO: swap to the arXiv abstract URL (arxiv.org/abs/XXXX.XXXXX) once the
% arXiv entry is live. Per Brendan, arXiv is preferred over the website copy
% for permanence; the website link below is an acceptable fallback as long as
% it stays active for >= 2 years. The published DOI'd page cannot be edited
% afterward, so finalize the arXiv link before the final upload.
