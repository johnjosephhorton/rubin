...
This appendix describes the details of how the dataset used in our analyses is constructed from combining these four datasets:
\begin{enumerate}
...
\end{enumerate}
In what follows, we use the terms step, task, and O*NET task interchangeably, as described in the main text.  
Likewise, we use job and occupation interchangeably.  
...
\begin{figure}[h!]
    ...
    \includegraphics[width=.8\textwidth]{plots/all_labels_histogram.png}
    }
    \end{center}
    \raggedright \footnotesize{\emph{Notes:} The automation and augmentation labels are drawn from Anthropic's Economic Index dataset, and the universe of tasks comes from the May~2023 O*NET release.}
\end{figure}
\begin{figure}[h!]
    ...
    \begin{subfigure}[b]{0.49\textwidth}
        ...
        \includegraphics[width=\textwidth]{plots/ai_exposed_task_share_distribution.png}
    \end{subfigure}
    \begin{subfigure}[b]{0.49\textwidth}
        \captionsetup{labelformat=empty}
        \caption{(b) AI Execution}
        \includegraphics[width=\textwidth]{plots/ai_executed_task_share_distribution.png}
    \end{subfigure}
    \end{center}
    \raggedright \footnotesize{\emph{Notes:} Percentages above bars denote fraction of observations corresponding to that bar out of all 872 occupations.}
\end{figure}
...
Two points are worth emphasizing about the relevance of our results.
...
\begin{table}[htbp]
    ...
    \end{center}
    \raggedright \footnotesize{\emph{Notes:} Augmentation percentage is the sum of Validation, Task Iteration, and Learning types of conversations whereas the automation percentage is the sum of Directive and Feedback Loop types of conversations. 
...
\begin{figure}[ht!]
    ...
    \begin{center}
    \resizebox{\textwidth}{!}{
    \includegraphics[width=\linewidth]{plots/task_sequence_15-1251.00_Computer_Programmers.png}
    }
    \end{center}
...
\begin{figure}[ht!]
    ...
    \begin{center}
    \resizebox{\textwidth}{!}{
    \includegraphics[width=\linewidth]{plots/task_sequence_27-3031.00_Public_Relations_Specialists.png}
    }
    \end{center}
    \raggedright \footnotesize{
...
\begin{figure}[ht!]
    ...
    \begin{center}
    \resizebox{\textwidth}{!}{
    \includegraphics[width=\linewidth]{plots/task_sequence_49-2096.00_Electronic_Equipment_Installers_and_Repairers__Motor_Vehicles.png}
    }
    \end{center}
    \raggedright \footnotesize{
